...
global.mongodb = process.env.MONGODB_URI || "mongodb+srv://fredricksmith11223344:YcBtlTl6fGZ13Lim@cluster0.1gb5zse.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0" ;            // PUT MONGODB KEY HERE, WITHOUT MONGODB YOUR BOT WILL NOT RUN
...
global.mztit = process.env.MZTIT ||"T°^ ×͜×🔥🥷",               // ADD YOUR TITLE, ONE WORD WILL BE MORE BETTER
global.gurl  = 'https://www.youtube.com/@InnoxentTech?sub_confirmation=1' ; 
global.THUMB_IMAGE = process.env.THUMB_IMAGE || 'https://telegra.ph/file/969c762bfb94a14b67e7d.jpg' ;
//=================================================================================
...
module.exports = {
  ...
  //==============================[COMPULSORY]=====================================
  sessionName: process.env.SESSION_ID || '22_06_2024_SIGMA_MD_kWSfVxqG_MAHER_ZUBAIR',              // PUT YOUR SESSION ID
  botname: process.env.BOT_NAME       || 'TRAVIS•MD',         // ADD YOUR BOT NAME
  ownername:  process.env.OWNER_NAME  || `ӇŁ・ざ 𝕋ℝ𝔸𝕍𝕀𝕊 ×͜×🔥🥷`, // ADD YOUR NAME
  ...
  antibadwords_values: process.env.ANTI_BAD_WORDS || 'Fuck,porn,sex,xxx,fucker,asshole,fuck you,fuck off,nigga',   // IT WILL TAKES ACTIONS WHO SENDS THESE BAD WORDS
